					...
					switch($element['type']) {
						...
						case 'youtube_video':
							...
							>
								...
								<iframe style="<?php echo stripslashes($element['custom_css']); ?>" class="cs-yt-iframe <?php echo stripslashes($element['custom_css_classes']); ?>" type="text/html" width="560" height="315" src="<?php echo 'http://www.youtube.com/embed/' . $element['video_id']; ?>?enablejsapi=1" frameborder="0"></iframe>
							</div>
							<?php
						break;
						...
						case 'vimeo_video':
							...
							>
								<div class="cs-avoid-interaction"></div>
								<iframe style="<?php echo stripslashes($element['custom_css']); ?>" class="cs-vimeo-iframe <?php echo stripslashes($element['custom_css_classes']); ?>" src="<?php echo 'https://player.vimeo.com/video/' . $element['video_id']; ?>?api=1" width="560" height="315" frameborder="0" ></iframe>
							</div>
							<?php
						break;
					}
...
function crellyslider_printTextElement($element) {
	...
	$animations = array(
		'none' => array('None'),
		'slideDown' => array('Slide down'),
		'slideUp' => array('Slide up'),
		'slideLeft' => array('Slide left'),
		'slideRight' => array('Slide right'),
		'fade' => array('Fade'),
		'fadeDown' => array('Fade down'),
		'fadeUp' => array('Fade up'),
		'fadeLeft' => array('Fade left'),
		'fadeRight' => array('Fade right'),
		'fadeSmallDown' => array('Fade small down'),
		'fadeSmallUp' => array('Fade small up'),
		'fadeSmallLeft' => array('Fade small left'),
		'fadeSmallRight' => array('Fade small right')
	);
	...
	<table class="cs-element-settings-list cs-text-element-settings-list cs-table">
		...
		<tbody>
			...
			<tr>
				...
				<td class="cs-content">
					<?php
					if($void) echo '<textarea class="cs-element-inner_html">Text element</textarea>';
			...
			<tr>
				...
				<td class="cs-content">
					...
					<br />
					<?php
					if($void) echo '<input class="cs-element-data_ignoreEaseOut" type="checkbox" />Disable synchronization with slide out animation';
					else {
			...
			<tr>
				...
				<td class="cs-content">
					...
					<br />
					<?php
					if($void) echo '<input class="cs-element-link_new_tab" type="checkbox" />Open link in a new tab';
					else {
			...
			<tr>
				...
				<td class="cs-content">
					...
					else echo '<input class="cs-element-custom_css_classes" type="text" value="' . $element['custom_css_classes'] . '" />';
					?>
				</td>
				<td class="cs-description">
