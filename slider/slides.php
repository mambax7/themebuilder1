		...
		<tbody>
					...
					<?php else: ?>
						...
						<form>
							...
							<?php if($slide['background_type_color_input'] == '1' || ($slide['background_type_color_input'] == '-1' && $slide['background_type_color'] != 'transparent')): ?>
								<input type="radio" value="1" name="cs-slide-background_type_color" checked /> <input class="cs_slide_background_type_color_picker_input" type="text" style="background-color: <?php echo $slide['background_type_color']; ?>" value="<?php echo $slide['background_type_color']; ?>" />
							<?php else: ?>
			...
			<tr>
				...
				<td class="cs-content">
					...
					<br />
					<?php
					if($void) echo '<input class="cs-background-link_new_tab" type="checkbox" />Open link in a new tab';
					else {
