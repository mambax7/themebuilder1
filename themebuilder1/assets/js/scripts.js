...
function mfnBuilder(){
	...
	var items = {
		...
		'menu'				: [ '1/6', '1/5', '1/4', '1/3', '2/5', '1/2', '3/5', '2/3', '3/4', '4/5', '5/6', '1/1' ],
		'slider'				: [ '1/6', '1/5', '1/4', '1/3', '2/5', '1/2', '3/5', '2/3', '3/4', '4/5', '5/6', '1/1' ],
		'block_xoops'				: [ '1/6', '1/5', '1/4', '1/3', '2/5', '1/2', '3/5', '2/3', '3/4', '4/5', '5/6', '1/1' ],
		'Blockcolumn'				: [ '1/6', '1/5', '1/4', '1/3', '2/5', '1/2', '3/5', '2/3', '3/4', '4/5', '5/6', '1/1' ],
	...
	jQuery( '.mfn-row-add-btn' ).click( function(){
		...
		if( sectionID.val() > 1 ){
			jQuery( '.mfn-row-add.last' ).fadeIn( 300, function(){
	...
	jQuery('.mfn-element-delete').click(function(){
		...
		if( jQuery( '#mfn-desk > .mfn-row').length == 1  ){
