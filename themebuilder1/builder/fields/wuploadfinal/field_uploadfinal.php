...
$healthy = array("mfn-rows[", "][]");
$yummy   = array("", "");

$id = str_replace($healthy, $yummy, $name);

		
		
        //$rmTpl->add_head_script('var imgmgr_title = "'.__('Image Manager','rmcommon').'"'."\n".'var mgrURL = "'.RMCURL.'/include/tiny-images.php";');
        $ret = "<script type='text/javascript' src='admin/themebuilder/fields/uploadfinal/popup-images-manager.js' ></script>";
		$ret .= "<script type='text/javascript' src='admin/themebuilder/fields/uploadfinal/advanced-fields.js' ></script>";
		$ret .= '<link rel="stylesheet" title="dark" media="screen" href="admin/themebuilder/fields/uploadfinal/popup-images-manager.css" type="text/css" />';
