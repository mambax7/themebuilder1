...
switch ($op) {
    case 'delpagebuilder':
        ...
        if ($ok == 1) {
            ...
            redirect_header("admin.php?fct=themebuilder1&op=layoutbuilder", 5, _AM_PAGE_ID_DELETED);
            exit();
            //echo 'delete from db après confirmation '.$pageid;
        } else {
            xoops_confirm(['pageid' => $_GET['pageid'], 'ok' => 1], 'admin.php?fct=themebuilder1&op=layoutbuilder&action=delpagebuilder', \_AM_ARABESK125DOTNET_OOOOOOOOOOOO_AREUSURE);
        }
    ...
    case 'clonepagebuilder':
        ...
        if ($ok == 1 && $_POST['confirm_submit'] == 'clone') {
            ...
            xoops_confirmk(
                ['pageid' => $_GET['pageid'], 'ok' => 1], 'admin.php?fct=themebuilder1&op=layoutbuilder&action=clonepagebuilder', '<div class="">Page Title: <input class="text-input" size="130" name="mfn-item-titre" type="text" placeholder="Your page titre" data-msg-required="This field is required." required=""></div>
    ...
    case 'modpagebuilderwrap':
        ...
        olivee_wajdi('layoutbuilder', $pageid);
    ...
    case 'addpagebuilder':
        ...
        include XOOPS_ROOT_PATH . '/modules/system/admin/themebuilder1/builder/wraper.php';
        echo 'add';
        olivee_wajdi('layoutbuilder', $pageid = false);
    ...
    default:
		...
		<div class="xo-buttons">
			<a class="ui-corner-all tooltip" href="admin.php?fct=themebuilder1&op=layoutbuilder&action=addpagebuilder" title="Add Layout">
				<img src="./images/icons/default/add.png" alt="" title="Add Layout">
				Add Layout
			</a>
			<a class="ui-corner-all tooltip" href="admin.php?fct=themebuilder2&op=layoutbuilder&action=importer&importerid=page" title="Import Layout">
				<img src="./images/icons/default/add.png" alt="" title="Import Layout">
				Import Layout
			</a>
		</div>
	</div>';
        ...
        global $xoopsDB;
        $sql21    = "SELECT distinct conf_modid, conf_id, conf_name, conf_title, conf_value FROM " . $xoopsDB->prefix("config_theme") . " WHERE conf_name = 'layoutbuilder' ORDER BY conf_id DESC";
        ...
        while ([$conf_modid, $conf_id, $conf_name, $conf_title, $conf_value] = $xoopsDB->fetchRow($result21)) {
            $icon = '<a href="admin.php?fct=themebuilder1&op=layoutbuilder&action=delpagebuilder&amp;pageid=' . $conf_id . '" title="DELETE"><img src="./images/icons/default/delete.png" alt="DELETE this Block"></a>&nbsp;';
            $icon .= '<a href="admin.php?fct=themebuilder1&op=layoutbuilder&action=modpagebuilderwrap&amp;pageid=' . $conf_id . '" title="MODIFY"><img src="./images/icons/default/edit.png" alt="MODIFY this Block"></a>';
            $icon .= '<a href="admin.php?fct=themebuilder1&op=layoutbuilder&action=clonepagebuilder&amp;pageid=' . $conf_id . '" title="CLONE"><img src="./images/icons/default/clone.png" alt="CLONE this Block"></a>';
            $icon .= '<a href="admin.php?fct=themebuilder1&op=layoutbuilder&action=exporter&amp;exporterid=page&amp;pageid=' . $conf_id . '" title="CLONE"><img src="./images/icons/default/clone.png" alt="CLONE this Block"></a>';
