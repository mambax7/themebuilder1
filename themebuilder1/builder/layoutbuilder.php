...
switch ( $op ) {
		...
		case 'delpagebuilder':
			...
			//echo 'delete from db après confirmation '.$pageid;
				...
				xoops_confirm(array('pageid' => $_GET['pageid'], 'ok' => 1), 'admin.php?fct=themebuilder1&op=layoutbuilder&action=delpagebuilder', _AM_ARABESK125dotNET_OOOOOOOOOOOO_AREUSURE);
			}
		...
		if ($ok == 1 && $_POST['confirm_submit'] == 'clone'){
			...
			xoops_confirmk(array('pageid' => $_GET['pageid'], 'ok' => 1), 'admin.php?fct=themebuilder1&op=layoutbuilder&action=clonepagebuilder', '<div class="">Titre de la page: <input class="text-input" size="130" name="mfn-item-titre" type="text" placeholder="Your page titre" data-msg-required="This field is required." required=""></div>
