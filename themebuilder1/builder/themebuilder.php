...
switch ($op) {
    case 'delpagebuilder':
        ...
        if ($ok == 1) {
            ...
            xoops_confirm(['pageid' => $_GET['pageid'], 'ok' => 1], 'admin.php?fct=themebuilder1&op=ThemeBuilder&action=delpagebuilder', \_AM_ARABESK125DOTNET_OOOOOOOOOOOO_AREUSURE);
        }
    ...
    case 'clonepagebuilder':
        ...
        if ($ok == 1 && $_POST['confirm_submit'] == 'clone') {
            ...
            xoops_confirmk(
                ['pageid' => $_GET['pageid'], 'ok' => 1], 'admin.php?fct=themebuilder1&op=pagebuilder&action=clonepagebuilder', '<div class="">Page Title: <input class="text-input" size="35" name="mfn-item-titre" type="text" placeholder="Your page titre" data-msg-required="This field is required." required=""></div>
    ...
    case 'modpagebuilderwrap':
        ...
        $templetebuilderid = $_POST['pageid'] ?? $_GET['pageid'];
