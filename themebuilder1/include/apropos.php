<?php
	...
	echo "<div style='margin-top: 10px; color: #33538e; margin-bottom: 4px; font-size: 18px; line-height: 18px; font-weight: bold; display: block;'>(3.0)</div>";
	...
	echo "</tr>";
		...
		echo "<td class='even' align='left'>3.0</td>";
		echo "</tr>";
		echo "<tr>";
