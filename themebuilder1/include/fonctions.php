	...
	$tree = new Tree;
		...
		foreach ($data1 as $row1) {
			...
			//echo $row1['title'];	
				...
				$output .= '<link rel="stylesheet" href="<{$xoops_url}>/modules/system/admin/themebuilder/icomoon.css">';
			...
			if( $attr['animate'] ) $output .= '<div class="animate" data-anim-type="'. $attr['animate'] .'">';
				$output .= '<div class="promo_box_wrapper promo_box_'. $attr['position'] .'">';
					...
					$output .= '<div class="desc_wrapper">';
						...
						if( $attr['btn_link'] ) $output .= '<a href="'. $attr['btn_link'] .'" class="button button_left button_theme button_js" '. $target .'><span class="button_icon"><i class="fa-icon-link"></i></span><span class="button_label">'. $attr['btn_text'] .'</span></a>';
					$output .= '</div>';
...
if( ! function_exists( 'sc_dropcap' ) )
{
	function sc_dropcap( $attr, $content = null )
	{
		...
		$style = '';
		if( $attr['background'] ) $style .= 'background-color:'.XOOPS_URL.'/themes/themebuilder/texture/bg/'. $attr['background'] .';';
		if( $attr['color'] ) $style .= ' color:'. $attr['color'] .';';
	...
	function sc_fancy_heading( $attr, $content = null )
	{
		...
		$output = '<div class="fancy_heading fancy_heading_'. $attr['style'].'">';	
			if( $attr['animate'] ) $output .= '<div class="animate" data-anim-type="'. $attr['animate'] .'">';
				...
				if( $attr['style'] =='arrows' ) $attr['title'] = '<i class="im-icon-arrow-right-14"></i>'. $attr['title'] .'<i class="im-icon-arrow-left-13"></i>';
				if( $attr['title'] ){
					if( $attr['h1'] ){
...
<script type="text/javascript" src="<{$xoops_url}>/modules/system/admin/themebuilder/slider/js/jquery.crellyslider.js"></script>';
						...
						$output .= '<li class="offer_li">';
							...
							$output .= '<div class="desc_wrapper">';
								...
								$output .= '<div class="title">';
									$output .= '<h3>title</h3>';
									if( $link ) $output .= '<a href="'. $link .'" class="button button_js" '. $target .'><span class="button_icon"><i class="fa-icon-layout"></i></span><span class="button_label">hhhhh</span></a>';
								$output .= '</div>';
