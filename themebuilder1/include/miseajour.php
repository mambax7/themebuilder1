...
define( 'MTHEME_NOTIFIER_XML_FILE_REC', XOOPS_ROOT_PATH . '/modules/system/admin/themebuilder/themebuiilder.xml' );
...
<link rel="stylesheet" type="text/css" media="all" href="admin/themebuilder/mfn.builder.css">
<div class="wrap">
...
width: 24%;
  ...
  <div id="instructions">
    ...
    <p><strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your Xoops installation folder <code>/modules/system/admin/themebuilder/
