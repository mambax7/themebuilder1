...
<head>
    ...
    <script>
        var subscribe_msg = ' . stripslashes((string) $meta_arr['ics_subscribe_msg']) . ';
        var send_msg_succes = ' . stripslashes((string) $meta_arr['ics_contact_s_msg']) . ';
...
<body class="ics-layout-' . $meta_arr['ics_layout'] . '">
    ...
    if ($meta_arr['ics_about_page_enable'] == 1 || $meta_arr['ics_contact_page_enable'] == 1) {
        $value['html'] .= '
                                            <li>
                                                <a href="javascript:void(0)" class="active" id="a_menu_' . $i . '">' . stripslashes((string) $meta_arr['ics_home_label']) . '</a>
                                            </li>';
    ...
    if ($meta_arr['ics_about_page_enable'] == 1) {
        $value['html'] .= '
                                            <li>
                                                <a href="javascript:void(0)" id="a_menu_' . $i . '" >' . stripslashes((string) $meta_arr['ics_about_label']) . '</a>
                                            </li>';
    ...
    if ($meta_arr['ics_contact_page_enable'] == 1) {
        $value['html'] .= '
                                            <li>
                                                <a href="javascript:void(0)" id="a_menu_' . $i . '">' . stripslashes((string) $meta_arr['ics_contact_label']) . '</a>
                                            </li>';
    }
    $value['html'] .= '        
                                </ul>
                ...
                <main role="main" class="clearfix">
                    <div class="row">
                        <div class="col-md-5 col-lg-5 col-bordered">
                            <div class="tag-line">
                                <h1 class="hm-1">' . stripslashes((string) $meta_arr['ics_title_1']) . '</h1>
                                <h2 class="hm-2">' . stripslashes((string) $meta_arr['ics_title_2']) . '</h2>
                                <h2 class="hm-3">' . stripslashes((string) $meta_arr['ics_title_3']) . '</h2>
                                <h3 class="hm-4">' . stripslashes((string) $meta_arr['ics_subtitle']) . '</h3>
                            </div><!-- /.tag-line -->';
        ...
        $value['html'] .= '
                            <div class="util">
                                ...
                                <span class="tooltip-show">
                                    ' . stripslashes((string) $meta_arr['ics_more_info_text']) . '
    ...
    if (isset($meta_arr['ics_title_more_info'])) {
        $value['html'] .= '' . htmlspecialchars(stripslashes((string) $meta_arr['ics_title_more_info'])) . '';
    } else {
    ...
    $value['html'] .= '      </h4>
                                        ...
                                        <div class="modal-body">
                                            <p>
                                                ' . htmlspecialchars_decode(stripslashes((string) $meta_arr['ics_more_info'])) . '
                                            </p>
                                        </div>
    ...
    $meta_arr["ics_end_date"] = str_replace('/', '-', (string) $meta_arr["ics_end_date"]);
        ...
        $value['html'] .= '
                            ...
                            <section class="pnl-2">
                                ...
                                <div class="row">
                                    ...
                                    <p>' . htmlspecialchars_decode(stripslashes((string) $meta_arr['ics_about_text'])) . '</p>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
            ...
            if ($meta_arr[$icon . '-enable'] == 1) {
                $value['html'] .= '
                                                     <div class="item">
                                                        ...
                                                        <p>' . stripslashes((string) $meta_arr[$icon . '-text']) . '</p>
                                                     </div>';
            }
        }
        $value['html'] .= '
    ...
    if ($meta_arr['ics_contact_page_enable'] == 1) {
        $value['html'] .= '
                            ...
                            <section class="pnl-3">
                                <div class="col-offset">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3>' . stripslashes((string) $meta_arr['ics_contact_title']) . '</h3>
                                        </div>
                                    </div>
                                    <div class="row">
        ...
        $placeholder = stripslashes((string) $meta_arr['ics_contact_name']);
        if ($placeholder != '') {
            $placeholder .= ' *';
        }
        $value['html'] .= '
        ...
        $placeholder = stripslashes((string) $meta_arr['ics_contact_email']);
        if ($placeholder != '') {
            $placeholder .= ' *';
        }
        $value['html'] .= '
        ...
        $placeholder = stripslashes((string) $meta_arr['ics_contact_message']);
        if ($placeholder != '') {
            $placeholder .= ' *';
        }
        $value['html'] .= '
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="col-sm-6">
                                                <button id="contact-submit" class="btn-contact"><i class="fa-ics fa-envelope-o-ics"></i>' . stripslashes((string) $meta_arr['ics_contact_submit']) . '</button>
    ...
    if ($meta_arr['ics_enable_subscribe'] == 1) {
        $value['html'] .= '
                    <form method="post" action="" class="subscribe-form">
                        ...
                        <input type="email" name="email" id="subscribe-email" placeholder="' . stripslashes((string) $meta_arr['ics_subscribe_label']) . '" required="">
                        <button id="subscribe-submit">' . stripslashes((string) $meta_arr['ics_subscribe_bttn']) . '</button>
    ...
    $value['html'] .= '
                    <div class="social-media">
                        <p>' . stripslashes((string) $meta_arr['ics_smb_text']) . '</p>
                        <ul>';
    ...
    $value['html'] .= '
                     ...
                     <small>' . stripslashes((string) $meta_arr['ics_copyright']) . '</small>
                </div>
            </div>
        </div>
    </footer>
...
$arr = [
    ...
    [
        ...
        'options'  => [
            '#0a9fd8' => '#0a9fd8', '#38cbcb' => '#38cbcb', '#27bebe' => '#27bebe', '#0bb586' => '#0bb586', '#94c523' => '#94c523', '#6a3da3' => '#6a3da3', '#f1505b' => '#f1505b', '#ee3733' => '#ee3733', '#f36510' => '#f36510', '#f8ba01' => '#f8ba01',
    ...
    [
        ...
        'std'   => XOOPS_URL . '/modules/system/admin/themebuilder1/fields/uploadframe/mlib-uploads/full/2successwoman-593c71727e113.png',
    ],
