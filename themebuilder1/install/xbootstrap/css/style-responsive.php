...
$mobileMenuInitW = $stickyMenuInitW = (!empty($xoTheme->template->_tpl_vars['mobile-menu-initial'])) ? $xoTheme->template->_tpl_vars['mobile-menu-initial'] : '1240';

$responsive_header_tab = $xoTheme->template->_tpl_vars['responsive-header-tablet'];
