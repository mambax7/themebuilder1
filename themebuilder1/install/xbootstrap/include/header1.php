...
{ 
 	function mfn_body_classes( )
	{
		...
		if( ! in_array( $skin, array('custom','one') ) ){
...
echo '<div class="logo'. $logo_class .'">';
	...
	/*if( $layoutID = mfn_layout_ID() ){
		...
		$logo['default']['sticky'] 			= $xoTheme->template->_tpl_vars[ 'sticky-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'sticky-logo-img' ] : $logo['default']['main'];
		$logo['default']['mobile']  		= $xoTheme->template->_tpl_vars[ 'responsive-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'responsive-logo-img' ] : $logo['default']['main'];
		$logo['default']['mobile-sticky']	= $xoTheme->template->_tpl_vars[ 'responsive-sticky-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'responsive-sticky-logo-img' ] : $logo['default']['main'];

		$logo['retina']['main']  			= $xoTheme->template->_tpl_vars[ 'retina-logo-img' ];
		$logo['retina']['sticky']  			= $xoTheme->template->_tpl_vars[ 'sticky-retina-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'sticky-retina-logo-img' ] : $logo['retina']['main'];
		$logo['retina']['mobile']  			= $xoTheme->template->_tpl_vars[ 'responsive-retina-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'responsive-retina-logo-img' ] : $logo['retina']['main'];
		$logo['retina']['mobile-sticky'] 	= $xoTheme->template->_tpl_vars[ 'responsive-sticky-retina-logo-img' ] ? $xoTheme->template->_tpl_vars[ 'responsive-sticky-retina-logo-img' ] : $logo['retina']['main'];
	//}
				...
				<div class="menu_wrapper">
					...
					echo '<nav id="menu"><ul id="menu-main-menu" class="menu menu-main"><li id="menu-item-7" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item"><a href="/"><span>Home</span></a></li><li id="menu-item-19" class="menu-item menu-item-type-post_type menu-item-object-page"><a href=""><span>Blog</span></a></li><li id="menu-item-20" class="menu-item menu-item-type-post_type menu-item-object-page"><a href=""><span>Portfolio</span></a></li><li id="menu-item-18" class="menu-item menu-item-type-post_type menu-item-object-page last"><a href=""><span>About</span></a></li><li id="menu-item-17" class="menu-item menu-item-type-post_type menu-item-object-page last"><a href=""><span>Contact</span></a></li></ul></nav>';
							...
							echo '<a class="responsive-menu-toggle '. $mb_class .'" href="#">';
								if( $menu_text = trim( $xoTheme->template->_tpl_vars[ 'header-menu-text' ] ) ){
