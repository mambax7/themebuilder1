 ...
 global $xoopsDB;
	...
	while (list($conf_id, $conf_name, $conf_catid, $conf_value, $conf_desc) = $xoopsDB->fetchRow($result)) {
        ...
        <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1200%; -webkit-transition-duration: 0.6s; transition-duration: 0.6s; -webkit-transform: translate3d(-3364px, 0px, 0px);"><li class="clone" style="width: 841px; float: left; display: block;">
            ...
            <li class="" style="width: 841px; float: left; display: block;">
  	    	    <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_cheesecake_brownie.jpg">
  	    		</li>
  	    		<li style="width: 841px; float: left; display: block;" class="">
  	    	    <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_lemon.jpg">
  	    		</li>
  	    		<li style="width: 841px; float: left; display: block;" class="">
  	    	    <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_donut.jpg">
  	    		</li>
  	    		<li style="width: 841px; float: left; display: block;" class="flex-active-slide">
  	    	    <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_caramel.jpg">
  	    		</li>
          <li class="clone" style="width: 841px; float: left; display: block;">
  	    	    <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_cheesecake_brownie.jpg">
  	    		</li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a class="">1</a></li><li><a class="">2</a></li><li><a class="">3</a></li><li><a class="flex-active">4</a></li></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#">Previous</a></li><li><a class="flex-next" href="#">Next</a></li></ul></div>
...
$(window).load(function() {
  $(".flexslider").flexslider({
    animation: "slide"
		...
		elseif ($conf_value == 'owlcarousel'){
		
		${'SLIDER'.$arg .'_'. $val} = "<link rel='stylesheet' href='http://localhost/xoops257sample/themes/xbootstrap/js/owl/owl.carousel.css'>";
		${'SLIDER'.$arg .'_'. $val} .= '<div id="myCarousel" class="carousel slide slideshow" data-ride="carousel">
<!-- Indicators -->
...
<div class="item"> <img alt="XOOPS" src="http://localhost/xoops257sample/themes/xbootstrap/images/slider1.jpg">
...
<div class="item active"> <img alt="XOOPS" src="http://localhost/xoops257sample/themes/xbootstrap/images/slider2.jpg">
    <div class="carousel-caption hidden-xs">
      <h1>Lorem ipsum dolor sit amet</h1>
      <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
      <p><a href="javascript:;" class="btn btn-large btn-primary">Read More</a></p>
