...
class MFN_Options_icon extends MFN_Options
{
    ...
    function render($meta = false)
    {
        ...
        echo '</div>';
        echo '<script src="' . MFN_OPTIONS_URI . 'fields/icon/field_icon.js" type="text/javascript"></script>';
    }
    ...
    function enqueue()
    {
        wp_enqueue_script('mfn-opts-field-icos-js', MFN_OPTIONS_URI . 'fields/icon/field_icon.js', ['jquery'], THEME_VERSION, true);
    }
}
