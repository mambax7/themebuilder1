...
class MFN_Options_upload extends MFN_Options
{
    ...
    function enqueue()
    {
        ...
        wp_enqueue_script('mfn-opts-field-upload-js', MFN_OPTIONS_URI . 'fields/upload/field_upload.js', ['jquery'], THEME_VERSION, true);

        wp_localize_script('mfn-opts-field-upload-js', 'mfn_upload', ['url' => $this->url . 'fields/upload/blank.png']);
    }
}
