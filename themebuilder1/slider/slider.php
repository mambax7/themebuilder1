    ...
    <table class="cs-slider-settings-list cs-table">
            ...
            <td class="cs-content">
                <select id="cs-slider-layout">
                    ...
                    foreach ($slider_select_options['layout'] as $key => $value) {
                        ...
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['layout'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
            ...
            <td class="cs-content">
                <select id="cs-slider-responsive">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['responsive'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <?php
                if (!isset($edit)) {
                    echo '<input id="cs-slider-startWidth" type="text" value="1140" />';
                } else {
                    echo '<input id="cs-slider-startWidth" type="text" value="' . $slider['startWidth'] . '" />';
                }
                ?>
                px
            </td>
        ...
        <tr>
            ...
            <td class="cs-content">
                <?php
                if (!isset($edit)) {
                    echo '<input id="cs-slider-startHeight" type="text" value="500" />';
                } else {
                    echo '<input id="cs-slider-startHeight" type="text" value="' . $slider['startHeight'] . '" />';
                }
                ?>
                px
            </td>
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-automaticSlide">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['automaticSlide'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-showControls">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['showControls'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-showNavigation">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['showNavigation'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-enableSwipe">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['enableSwipe'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-showProgressBar">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['showProgressBar'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
        ...
        <tr>
            ...
            <td class="cs-content">
                <select id="cs-slider-pauseOnHover">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['pauseOnHover'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
            ...
            <td class="cs-content">
                <select id="cs-slider-randomOrder">
                    ...
                    foreach ($slider_select_options['boolean_not'] as $key => $value) {
                        echo '<option value="' . $key . '"';
                        if ((!isset($edit) && isset($value[1])) || (isset($edit) && $slider['randomOrder'] == $key)) {
                            echo ' selected';
                        }
                        echo '>' . $value[0] . '</option>';
                    }
            ...
            <td class="cs-content">
                <select id="cs-slider-startFromSlide">
                    ...
                    if (!isset($edit)) {
                        ...
                        if (isset($edit) && $slider['startFromSlide'] == -1) {
                            echo '<option selected value="-1">Random slide</option>';
                        } else {
                        ...
                        for ($i = 0, $iMax = count($slides); $i < $iMax; $i++) {
                            echo '<option value="' . $i . '"';
                            if ((!isset($edit) && $i == 0) || (isset($edit) && $slider['startFromSlide'] == $i)) {
                                echo ' selected';
                            }
        ...
        <tr>
            ...
            <td class="cs-content">
                <?php
                if (!isset($edit) || (isset($edit) && stripslashes((string) $slider['callbacks']) == '')) {
...
<?php
                    ...
                    echo '<textarea id="cs-slider-callbacks">' . stripslashes((string) $slider['callbacks']) . '</textarea>';
                }
                ?>
            </td>
            <td class="cs-description">
